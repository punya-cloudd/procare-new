                        ...
                        <div class="card-body p-4">
                            <div class="row g-3">
                                ...
                                @if(auth()->user()->hasRole('Peserta'))
                                    {{-- Petugas Otomatis Kosong jika Login sebagai Peserta --}}
                    ...
                    <div class="card border-0 shadow-sm rounded-3 text-white card-gradient-summary mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex align-items-baseline">
                                <input type="number" id="totalKalori" class="display-kalori fw-bold bg-transparent border-0 text-white w-100" value="0" readonly>
                            </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 p-3">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                    ...
                    <div class="d-flex gap-2 w-100 w-md-auto">
                        ...
                        <button type="submit" class="btn btn-primary-gradient text-white w-50 w-md-auto px-4 shadow-sm">
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '.masterMakanan', function() {
            ...
            if (satuanDb.toLowerCase() === 'gram' || satuanDb.toLowerCase() === 'g') {
                // Otomatis arahkan ke Porsi/Piring agar pasien tidak bingung dengan Gram
                selectSatuan.append(`
                    <option value="Porsi" selected>Porsi / Piring (±150g)</option>

    ...
    <div class="container">
        <div class="page-inner">
                            ...
                            <div class="d-flex align-items-center mb-3 mb-md-0">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex flex-wrap gap-2 align-items-center">
                                        ...
                                        <span class="badge bg-light text-dark border">BPJS:
                                            {{ $peserta->no_bpjs ?? '-' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 ps-md-4">
                            <div class="row g-2 text-sm">
                                ...
                                <div class="col-6">
                                    ...
                                    <span
                                        class="fw-semibold text-dark">{{ $peserta->jenisPenyakit->nama_penyakit ?? 'tidak ada' }}</span>
                                </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100"
                        style="background-color: #e8f5e9; border-left: 5px solid #2e7d32 !important;">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100"
                        style="background-color: #fff3e0; border-left: 5px solid #ef6c00 !important;">
                        <div class="card-body d-flex align-items-center justify-content-between p-3">
                            <div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100"
                        style="background-color: #ffebee; border-left: 5px solid #c62828 !important;">
                        <div class="card-body d-flex align-items-center justify-content-between p-3">
                            <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-light text-dark border">
                                                <i
                                                    class="fas fa-user-edit me-1"></i>{{ $item->petugas->nama ?? 'Mandiri (Pasien)' }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="text-center fw-bold text-dark">
                                            {{ number_format($item->total_kalori) }} <small
                                                class="text-muted fw-normal">Kkal</small>
                                        </td>
            ...
            <div class="p-4 rounded-3 shadow-sm mb-4" style="{{ $boxStyle }}">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div>
                        ...
                        @if ($isSesuai)
                            <p class="mb-0">
                                Asupan energi peserta secara umum <strong>sudah sesuai</strong> dengan target kebutuhan
                                kalori harian.
                                Sangat disarankan untuk terus mempertahankan pola makan dan aktivitas fisik yang telah
                                berjalan saat ini.
                            </p>
                        @elseif($isKurang)
                            <p class="mb-0">
                                Asupan energi peserta lebih sering berada <strong>di bawah target (kurang)</strong>.
                                Disarankan untuk meningkatkan konsumsi porsi makanan bergizi seimbang sesuai dengan acuan
                                kalori harian.
                            </p>
                        @else
                            <p class="mb-0">
                                Asupan energi peserta lebih sering <strong>melebihi target</strong> yang ditentukan.
                                Disarankan untuk membatasi konsumsi makanan tinggi gula & lemak, serta mengimbanginya dengan
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                <a href="{{ route('monitoring_makanan.evaluasi.pdf', [
                    'peserta' => $peserta->id,
                    'dari' => request('dari'),
                ...
                <a href="{{ route('monitoring_makanan.evaluasi.excel', [
                    'peserta' => $peserta->id,
                    'dari' => request('dari'),
                    'sampai' => request('sampai'),
                    'jumlah' => request('jumlah'),
